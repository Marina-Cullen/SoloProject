...
public class StoryController {
	...
	// CREATE-GET
	@GetMapping("/prompt/{id}/story")
	public String createStory(@PathVariable("id") Long id, Model viewModel, Model model) {
	...
	public String updateStoryPost(@PathVariable("id") Long id,
			@Valid @ModelAttribute("updatedStory") Story updatedStory, BindingResult result, Model model) {
		// VALIDATORS ARE RAN
		if (result.hasErrors()) {
